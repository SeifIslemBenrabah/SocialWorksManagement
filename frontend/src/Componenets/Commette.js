  ...
  return (
    <div className='flex flex-row w-full h-screen font-poppins'>
        ...
        <div className='flex flex-col gap-3'>
            ...
            <Link className='flex flex-row gap-3 px-6 w-full'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div className='flex flex-col gap-3'>
            <a className='flex flex-row gap-3 px-6 w-full'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <button onClick={handleLogout} className='flex flex-row gap-3 px-6 w-full'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
