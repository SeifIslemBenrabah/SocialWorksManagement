    ...
    <div className='flex flex-row w-full h-screen font-poppins'>
      <div className='w-1/6 h-screen flex flex-col shadow-md bg-white'>
        ...
        <div className='flex flex-col justify-between h-full py-6'>
          <div className='flex flex-col gap-3'>
            <Link to='u-programmes' className='flex flex-row gap-3 px-6 w-full'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
              </svg>
              <p className='hidden md:block'>Programmes</p>
            </Link>
            <Link to='u-demand' className='flex flex-row gap-3 px-6 w-full'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
          ...
          <div className='flex flex-col gap-3'>
            ...
            <Link to='profile' className='flex flex-row gap-3 px-6 w-full'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      ...
      <div className='w-5/6 h-full flex flex-col'>
        <div className='w-full flex flex-row py-4 justify-between pl-6 pr-6 items-center bg-white shadow-sm'>
          <div className='text-xl font-bold text-dblue'>Employee Portal</div>
