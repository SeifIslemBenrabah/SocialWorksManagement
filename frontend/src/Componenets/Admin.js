...
const Admin = () => {
  ...
  const isActive = (segment) => {
    ...
    if (segment === 'dashboard') return path === '/Admin' || path === '/Admin/dashboard';
    return path.startsWith(`/Admin/${segment}`);
  };
