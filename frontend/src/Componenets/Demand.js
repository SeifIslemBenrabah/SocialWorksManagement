...
const Demand = () => {
    return (
        <div className='w-full flex flex-col pt-10 items-center gap-6 bg-secondary pb-7 font-poppins'>
          ...
          <div className=' flex flex-col w-9/12 h-[420px] border-[1px] gap-2 rounded-xl overflow-hidden px-2 shadow-md bg-white2'>
        <div className='flex flex-row pt-4 w-full justify-between px-8'>
            <select name="langageMaitrise" className='w-3/12 border-2 border-dblue focus:outline-none rounded-md py-1 px-2'>
      ...
      <div class="relative group">
        ...
        <div className='flex flex-row py-2 w-full justify-between px-28 bg-pblue bg-opacity-10 items-center rounded-2xl'>
            <p>Employee Name</p>
            <p>Programme Name</p>
            <p>Date</p>
            <p>state</p>
